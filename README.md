...
- **53 trò chơi** trong cùng một ứng dụng
...
- **Song ngữ Việt / Anh** (nút 🌐) — dịch **toàn bộ**: khung giao diện, tên + mô tả + hướng dẫn của 53 game, và **trạng thái khi đang chơi** (thông báo lượt, nhãn HUD, nút trong game). Có test tự động chống sót chữ Việt.
...
WebSocket tạo/vào phòng, **quét chữ Việt còn sót khi ở chế độ tiếng Anh** cho cả 53 game,
...
└── js/
    ...
    ├── games-i18n.js   # Tên + mô tả tiếng Anh của 53 game
