  ...
  const GAME_GROUPS = [
    {
      ...
      games: ["tictactoe", "ultimatettt", "gomoku", "connectfour", "reversi", "pentago", "morris", "checkers", "minichess", "isolation", "sim", "sprouts", "laserchess", "pathlockduel", "hunterswarm", "hex", "quoridor", "mancala", "dotsandboxes", "orderchaos", "nim", "stratego"],
    },
    {
