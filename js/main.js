  ...
  const GAME_GROUPS = [
    {
      ...
      games: ["tictactoe", "ultimatettt", "gomoku", "connectfour", "reversi", "pentago", "morris", "checkers", "minichess", "konane", "hive", "tak", "kamisado", "amazons", "isolation", "sim", "sprouts", "laserchess", "pathlockduel", "hunterswarm", "hex", "quoridor", "mancala", "dotsandboxes", "orderchaos", "nim", "stratego"],
    },
    {
    ...
    },
    {
      ...
      hintKey: "grpLongHint",
      games: ["coopdefense", "basedefenseduel", "robotfactorywar", "dungeonrival", "tycoon", "boxpush", "mazecoop", "defusebomb"],
    },
    {
