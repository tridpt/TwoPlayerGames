...
### Added — Đã thêm
- **Mở rộng từ 47 lên 55 trò chơi** với 8 game mới:
  - **6 game chơi ONLINE** (qua relay, đồng bộ tất định từ seed chung): **Rắn & Thang** (🪜),
  ...
  - **2 game phản xạ chung máy**: **Đua Bấm Nút** (⚡ chờ đèn xanh, có đếm ngược + kỷ lục phản xạ),
    **Đua Né Chướng Ngại** (🏃 né khối, có particle va chạm + tốc độ tăng dần).
...
- **Test đồng bộ online** (`tests/online-sync-it.js`): mô phỏng 2 client cho cả 6 game online,
